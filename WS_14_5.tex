...
\begin{enumerate}
	...
	{ The level sets look like $xy = k$, which are just hyperbolas. The quadrants where the hyperbolas live are determined by the nature of $k$. For example, $f(x,y)=-4$ is a hyperbola in quadrants 2 and 4. We have $\nabla f = (y,x)$ so $\nabla f (2,-2) = (2,2)$ which should be orthogonal to the tangent line. One can also compute the tangent line explicitly but this is not necessary.
	}
\end{enumerate}
