...
\begin{enumerate}[resume]
	...
	plane $z=2y+1$, i.e. \[D=\{(x,y,z) \in \R^3 \mid x^2+y^2 \leq z \leq 2y+1\}.\] 
	Write triple iterated integrals in the orders $dz\ dy\ dx$ and  $dz\ dx\ dy$
	that give the volume of $D$.  Can you write a single triple iterated integral for this volume using any other orders of integration? What about doing the $x-$ and $y-$ bounds in polar form? \textit{[This is a nod to next week's material.]}
