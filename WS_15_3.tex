...
\begin{enumerate}
        ...
        \item \question{
        A metal triangular plate with vertices $(0,0)$, $(2,0)$ and $(2,4)$ has temperature equal to $C(x,y) = 2+\cos(x^2)$ degrees Celsius. Compute the average temperature of the plate. \textit{[Hint: Choose a favourable order of integration.]}
        }
        {% answer here
